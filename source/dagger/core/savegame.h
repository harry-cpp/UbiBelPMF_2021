...
//SERIALZIE FLOAT
template<>
JSON::json SerializeComponent(float& input_)
{
    return JSON::json{ { "x", input_ } };
}

template<>
void DeserializeComponent(JSON::json input_, float& fill_)
{
    fill_ = input_["x"];
}
...
//serialize beans
template<>
JSON::json SerializeComponent(BeanComponent& input_)
{
    JSON::json save{};
    save["how_many_beans"] = SerializeComponent(input_.howManyBeans);
    return save;
}

template<>
void DeserializeComponent(JSON::json input_, BeanComponent& fill_)
{
    DeserializeComponent(input_["how_many_beans"], fill_.howManyBeans);
}
